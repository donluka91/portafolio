                    ...
                    iframe.load(function () {
                        ...
                        if (redirect) {
                            ...
                            $.ajax({
                                ...
                                url:baseUrl + "/?option=com_uniform&view=form&task=form.getHtmlForm&tmpl=component&form_id=" + $(selfsubmit).find("input[name=form_id]").val(),
