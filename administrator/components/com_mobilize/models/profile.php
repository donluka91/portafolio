    ...
    public function saveDataDesign($post) {
        ...
        if (isset($post['jsnmobilize']) && count($post['jsnmobilize']) && $profileId) {
            ...
            if (isset($post['style'])) {
                ...
                if (!empty($post['mobilize_custom_css_files']) || empty($post['mobilize_custom_css_files'])) {
                    $table = JTable::getInstance('Design', 'JSNMobilizeTable');
                ...
                if (!empty($post['mobilize_custom_css_code']) || empty($post['mobilize_custom_css_code'])) {
